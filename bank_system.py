...
class BankSystem(object):
    ...
    def loadBankData(self):
        ...
        customer_1 = Customer("Parul", "1234", ["14", " Street2", "Sirsa" , "Haryana"])
        account_no = 90455673
        account_1 = hesabjari(account_no, "Naruto", "1234", 5000)
        customer_1.openAccount(account_1)
        self.customerList.append(customer_1)


        customer_2 = Customer("Palak", "password", ["60", "Street1", "tehran" , "hesabboland"])
        account_no += 1
        account_2 = hesabjari(account_no, "Minato", "2601", 3200)
        account_no += 1
        ...
        customer_3 = Customer("Jashit", "moonlight", ["5", "Street3", "tabriz", "hesabkotah"])
        account_no += 1
        account_4 = hesabkotah(account_no, "Obito", "1010", 18000)
        customer_3.openAccount(account_4)
        self.customerList.append(customer_3)


        customer_4 = Customer("ParulS", "9876",["44", "nishan tashi", "istanbul", "hesabjari"])
        account_no+= 1
        account_5 = hesabjari(account_no, "Nagato", "6666", 50)
        customer_4.openAccount(account_5)
        self.customerList.append(customer_4)


        #create admins and add them to admins_list
        admin_1 = Admin("Rupal", "98765987651", True, ["12", "maqsodiye", "tehran" , ""])
